...
implements BSTInterface<T>
{
    ...
    //Project 6
    private void printTreeRec(BSTNode<T> tree, int level)
    {
        int parentLevel = level;
        if(tree != null){
            if(tree.getRight() != null){
                printTreeRec(tree.getRight(), level+1);
            } 
            ...
            System.out.print("\n");
            if(tree.getLeft() != null){
                printTreeRec(tree.getLeft(), level+1);
            }
        }else return;
    }
    ...
    //Take home final Q1
    private void printOutlineRec(BSTNode<T> tree, int level)
    {
        int parentLevel = level;
        if(tree != null){
            for(int i=0; i< parentLevel; i++){
            ...
            System.out.println(tree.getInfo());
            if(tree.getLeft() != null){
                printOutlineRec(tree.getLeft(), level+1);
            }
            if(tree.getRight() != null){
                printOutlineRec(tree.getRight(), level+1);
            } 
        }else return;
    }

    public void printOutline(){
        printOutlineRec(root, 0);
    }
